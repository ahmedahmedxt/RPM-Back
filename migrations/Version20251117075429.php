 ...
 */
final class Version20251117075429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devises (devisesId INT AUTO_INCREMENT NOT NULL, devisesLibelle VARCHAR(254) DEFAULT NULL, devisesAcronyme VARCHAR(10) DEFAULT NULL, deviseSymbole VARCHAR(3) DEFAULT NULL, PRIMARY KEY(devisesId)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE organismeDemandeur (organismeDemandeurId INT AUTO_INCREMENT NOT NULL, organismeDemandeurRaisonSociale VARCHAR(255) NOT NULL, organismeDemandeurRaisonSocialeShort VARCHAR(10) NOT NULL, organismeDemandeurDescription LONGTEXT DEFAULT NULL, organismeDemandeurLogo VARCHAR(255) DEFAULT NULL, organismeDemandeurCoordinateurPrenomNom VARCHAR(150) DEFAULT NULL, organismeDemandeurCoordinateurEmail VARCHAR(180) DEFAULT NULL, organismeDemandeurCoordinateurTel VARCHAR(50) DEFAULT NULL, organismeDemandeurAdresse VARCHAR(500) DEFAULT NULL, organismeDemandeurTelephone VARCHAR(50) DEFAULT NULL, organismeDemandeurEmail VARCHAR(180) DEFAULT NULL, organismeDemandeurPersonneContactPrenomNom1 VARCHAR(150) DEFAULT NULL, organismeDemandeurPersonneContactTelephone1 VARCHAR(50) DEFAULT NULL, organismeDemandeurPersonneContactEmail1 VARCHAR(180) DEFAULT NULL, organismeDemandeurPersonneContactPrenomNom2 VARCHAR(150) DEFAULT NULL, organismeDemandeurPersonneContactTelephone2 VARCHAR(50) DEFAULT NULL, organismeDemandeurPersonneContactEmail2 VARCHAR(180) DEFAULT NULL, organismeDemandeurPersonneContactPrenomNom3 VARCHAR(150) DEFAULT NULL, organismeDemandeurPersonneContactTelephone3 VARCHAR(50) DEFAULT NULL, organismeDemandeurPersonneContactEmail3 VARCHAR(180) DEFAULT NULL, paysId INT DEFAULT NULL, natureOrganismeDemendeurId INT DEFAULT NULL, secteurActiviteId INT DEFAULT NULL, INDEX IDX_CA856B3635569A8D (paysId), INDEX IDX_CA856B36B05759EF (natureOrganismeDemendeurId), INDEX IDX_CA856B36BEFC80CA (secteurActiviteId), PRIMARY KEY(organismeDemandeurId)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE organismeDemandeur ADD CONSTRAINT FK_CA856B3635569A8D FOREIGN KEY (paysId) REFERENCES pays (paysId) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE organismeDemandeur ADD CONSTRAINT FK_CA856B36B05759EF FOREIGN KEY (natureOrganismeDemendeurId) REFERENCES nature_organisme_demendeur (nature_organisme_demendeur_id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE organismeDemandeur ADD CONSTRAINT FK_CA856B36BEFC80CA FOREIGN KEY (secteurActiviteId) REFERENCES secteur_activite (secteur_activite_id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE organismeDemandeur DROP FOREIGN KEY FK_CA856B3635569A8D');
        $this->addSql('ALTER TABLE organismeDemandeur DROP FOREIGN KEY FK_CA856B36B05759EF');
        $this->addSql('ALTER TABLE organismeDemandeur DROP FOREIGN KEY FK_CA856B36BEFC80CA');
        ...
        $this->addSql('DROP TABLE organismeDemandeur');
